class Form {
  ...
  //as características estão no style
  setElementsStyle() {
    //título
  ...
  //criar um método para quando clicar ter vários acontecimentos
  ...
  this.input.hide();
  this.playButton.hide();
  var mensagem =`ola,${this.input.value()}
  </br> waiting another player`;
